...
class OrderApiController extends APIController {
    ...
    public function free_course_order(Request $request) {
        ...
        try {
            ...
            if ($course) {
                ...
                $messageOrder = 'Your order has been successfully processed. Please check your purchased list.';
    ...
    function student_purchased_course(Request $request) {
        ...
        $order_result = Order::where('student_id', $student_id)->where('orders.status', '=', 1)->wherenotnull('orders.payment_amount')
